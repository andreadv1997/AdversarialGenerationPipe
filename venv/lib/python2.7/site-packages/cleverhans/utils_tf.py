...
def model_train(sess, x, y, predictions, X_train, Y_train, save=False,
    ...
    train_step = tf.train.AdamOptimizer(learning_rate=args.learning_rate) #qui e' possibile definire il tipo di ottimizzatore da utilizzare. Per conformita' con altri approcci
